      ...
      <tbody>
        <?php foreach ($products as $product): ?>
          <tr>
            ...
            <td>
              <a href="edit_product.php?product_id=<?php echo htmlspecialchars($product['product_id']); ?>"><button class="btn">Edit</button></a>
              <a href="delete_product.php?product_id=<?php echo htmlspecialchars($product['product_id']); ?>"><button class="btn">Delete</button></a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
