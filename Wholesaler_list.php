            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        $wholeseller_id = $row['wholeseller_id'];
                        echo "<tr>
                            <td>" . htmlspecialchars($row['wholeseller_id']) . "</td>
                            <td>" . htmlspecialchars($row['name']) . "</td>
                            <td>" . htmlspecialchars($row['contact']) . "</td>
                            <td>" . (isset($row['house']) ? htmlspecialchars($row['house']) : '') . ", " . 
                            ...
                            <td>
                                <div class='action-buttons'>
                                    <a href='Wholesaler.php?edit_id=" . $wholeseller_id . "' class='edit-btn'>
                                        <i class='fas fa-edit'></i>Edit
                                    </a>
                                    <a href='javascript:void(0)' class='delete-btn' 
                                       onclick='deleteWholesaler(\"" . $wholeseller_id . "\")'>
