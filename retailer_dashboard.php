...
// session_start() is already called inside server.php
...
// Check if selected retailer profile is set from Update Profile page
$retailer = null;
...
<div class="sidebar">
  ...
  <a href="buyers_in_retailer.php">Buyer Info</a>
  <div class="dropdown" onclick="toggleDropdown()">
    <a>Analytics</a>
    <div class="dropdown-content" id="analyticsDropdown">
      <a href="price_trends.php">Price Trends</a>
    </div>
  </div>
...
<div class="main">
  <h1 style="font-size: 2.5rem; margin-bottom: 30px;">Welcome to Your Retailer Dashboard</h1>
  ...
  <div class="retailer-info">
    ...
    <?php if ($retailer): ?>
      ...
      <p><strong>Location:</strong> 
        <?= htmlspecialchars($retailer['road']) ?>, 
        <?= htmlspecialchars($retailer['area']) ?>, 
        <?= htmlspecialchars($retailer['district']) ?>, 
        <?= htmlspecialchars($retailer['country']) ?>
      </p>
    <?php else: ?>
      <p><strong>Retailer ID:</strong> Not Updated</p>
