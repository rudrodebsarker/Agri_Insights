    ...
    <div class="container">
        ...
        <form class="filter-form" method="GET" action="">
            ...
            <?php if (isset($_GET['filter_id']) && !empty($_GET['filter_id'])): ?>
                <a href="Retailer_list.php" class="clear-filter">Clear</a>
            <?php endif; ?>
        </form>
        ...
        <table>
            ...
            <tbody>
                <?php
                // Fetch retailers based on filter query
                $sql = "SELECT * FROM retailer" . $filterQuery . " ORDER BY retailer_id DESC";
